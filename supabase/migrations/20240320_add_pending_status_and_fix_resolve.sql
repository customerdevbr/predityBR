-- ═══════════════════════════════════════════════════════════════
-- PredityBR — Migração: Adiciona PENDING ao enum market_status
--             e atualiza resolve_market para aceitar PENDING.
-- Execute no SQL Editor do Supabase antes de ativar o cron.
-- ═══════════════════════════════════════════════════════════════

-- ────────────────────────────────────────────────────────────────
-- 1. Adiciona 'PENDING' ao enum market_status
-- (ALTER TYPE ADD VALUE não pode rodar dentro de uma transação,
--  mas o SQL Editor do Supabase executa fora de bloco — ok)
-- ────────────────────────────────────────────────────────────────
ALTER TYPE market_status ADD VALUE IF NOT EXISTS 'PENDING';

-- ────────────────────────────────────────────────────────────────
-- 2. Atualiza resolve_market para aceitar OPEN ou PENDING
-- ────────────────────────────────────────────────────────────────
...
-- ────────────────────────────────────────────────────────────────
-- 3. Recria o índice de auto-mercados (agora PENDING existe no enum)
-- ────────────────────────────────────────────────────────────────
DROP INDEX IF EXISTS idx_markets_auto;
